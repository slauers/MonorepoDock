...
export function AnalyzeAffected(arg1:string):Promise<affected.Report>;

export function AnalyzeDependencies(arg1:string):Promise<deps.Report>;

export function AnalyzeWorkspace(arg1:string):Promise<analyzer.Report>;

export function CheckPortConflicts(arg1:string,arg2:string):Promise<ports.Report>;

export function CloseApp():Promise<void>;

export function CommandWithPort(arg1:string,arg2:string,arg3:number):Promise<string>;
...
export function StopPortProcess(arg1:string,arg2:number,arg3:string):Promise<void>;
